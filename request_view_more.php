...
<div class="container-fluid">
    <a class="navbar-brand" href="request_view.php">
...
<hr style="width:50rem; margin:20px auto; border:1px solid #ccc;">
...
function confirmSubmit() {
 ...
 <form action="Accept.php" method="post" onsubmit="return confirmSubmit()">
  <input type="hidden" name="id" value="<?php echo $display['requestid']; ?>">
<button type="submit" name="Accept">Accept</button></a>
  <button type="submit" name="Reject"  >Reject</button></a>  
