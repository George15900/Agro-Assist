...
<div class="container-fluid">
    <a class="navbar-brand" href="comment.php">
        Back <i class="bi bi-arrow-left-short"></i>
    </a></div>
<center><h1>FeedBack</h1></center><br><center>
...
<div class="card" style="width: 50rem; margin: 20px auto;">
  ...
  <ul class="list-group list-group-flush">
    ...
    <li class="list-group-item d-flex">
     ...
     <form action="feedback_action.php" method="post"><!--//form -->
    <div class="mb-3">
  ...
  <center>
    <input type="hidden" class="btn btn-primary" name="rid" value="<?php echo $display['requestid'];?>">
    <input type="submit" class="btn btn-primary" name="Submit"> </center>
</form>
  </ul>
</div>
